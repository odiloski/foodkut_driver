...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF5a3633))), colorScheme: const ColorScheme.dark(primary: Color(0xFF5a3633), secondary: Color(0xFF5a3633)).copyWith(error: const Color(0xFFdd3135)),
